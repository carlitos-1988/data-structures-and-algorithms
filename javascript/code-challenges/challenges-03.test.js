...
const typeNum = (arr) => {
  // Solution code here...
  // let numbersOnly = [];
  // numbersOnly = arr.filter(function(val,idx){
  //   if(typeof val === 'number'){
  //     numbersOnly.push(val);
  //   }
...
const containsAnd = (arr) => {
  // Solution code here...
  return arr.filter(inputString =>
    inputString.includes('and')
  );
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  //const myTogetherArrays = [...forbiddenValues,...arr];
  return arr.filter(numers =>
    !forbiddenValues.includes(numers)
  );
