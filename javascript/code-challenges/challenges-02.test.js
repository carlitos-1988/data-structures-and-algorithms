...
const addOne = (arr) => {
  ...
  const newNumber = arr.map(addOne);
  return newNumber;
...
const addQuestion = (arr) => {
  // Solution code here...
  function addQuestion(x){return x+'?';}
  const myQuestions = arr.map(addQuestion);
  return myQuestions;
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let i=0; i<arr.length; i++){
    myNewArray.push( Math.pow(2,arr[i]));
  }
...
const forEachTwoToThe = (arr) => {
  ...
  const myReturnArray = [];
  arr.forEach(number =>{
    myReturnArray.push(Math.pow(2,number));
  });
...
const mapTwoToThe = (arr) => {
  ...
  function myFunction(x){
    const tempNumber = Math.pow(2,x);
    myReturnArray.push(tempNumber);
  }
...
const charCode = (arr) => {
  ...
  let myReturnArray = [];
  for(let i =0; i<arr.length; i++){
    myReturnArray.push(arr[i].charCodeAt());
  }
...
const evenOdd = (arr) => {
  ...
  function myFunction(x){
    if(typeof(x) ==='string'){
      myReturnArray.push('N/A');
    } else if(x % 2 === 0 ){
      myReturnArray.push('even');
    }else if(x %2 !== 0){
      myReturnArray.push('odd');
    }else{
      myReturnArray.push('N/A');
    }
  }
...
const extractAbilities = (arr) => {
  ...
  function extractAbilities(x){
    for(let i=0; i<x.length;i++){
      PokemonAbilities.push(x.ability);
    }
  }
  arr.map(extractAbilities);
